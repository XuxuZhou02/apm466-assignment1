...
\vspace{-2mm}
\section*{References \& GitHub}
\begin{enumerate}[label={[\arabic*]}, nosep, leftmargin=*, itemsep=0pt, parsep=0pt]
\footnotesize
\item Business Insider Bond Data. \url{https://markets.businessinsider.com/bonds}
\item Hull, J. C. (2021). \textit{Options, Futures, and Other Derivatives}.
\item Litterman, R., \& Scheinkman, J. (1991). Common factors affecting bond returns.
\end{enumerate}
All code and data: \url{https://github.com/YOUR-USERNAME/APM466_Assignment_1}
